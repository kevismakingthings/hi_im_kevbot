...
var all_shaders: Array[ShaderMaterial] = [
	...
	preload("res://ASSETS/visual_presets/shaders/shiny.tres"),
	preload("res://ASSETS/visual_presets/shaders/squiggly.tres"),
	preload("res://ASSETS/visual_presets/shaders/start_pixel.tres"),
	preload("res://ASSETS/visual_presets/shaders/CRT.tres"),
	preload("res://ASSETS/visual_presets/shaders/skillbar.tres")
